...
### Como será adaptado?
A coluna lateral vira a área "Onde passa", com os grupos No seu controle, Em outros canais, Aluguel e Compra. O título usa tipografia condensada de cartaz (Anton) em vez de serifada, e o backdrop recebe scanlines leves para manter a linguagem de TV.
