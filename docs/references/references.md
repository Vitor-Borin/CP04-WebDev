...
### Como será adaptado?
A coluna lateral vira a área "Onde passa", com os grupos No seu controle, Em outros canais, Aluguel e Compra. O título usa a Radio Canada Big, fonte feita para a CBC/Radio-Canada (a rádio e TV pública do Canadá), no lugar de uma serifada. O backdrop ganha scanlines leves, como uma imagem de TV.
...
### Onde foi usado e por que é adequado?
Nas seções de onde assistir da página do título, no componente `ProviderGroup`. É adequado porque o problema do produto é uma comparação (onde vale mais a pena assistir) e esse padrão de linhas com destaque da melhor opção é o que o Google Voos usa para facilitar esse tipo de escolha.
